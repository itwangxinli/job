...
public class ElasticJobHandler {
    ...
    public void addJob(String jobName, String cron, Integer shardingTotalCount, String id) {
        LiteJobConfiguration jobConfig = simpleJobConfigBuilder(jobName, JavaSimpleJob.class, shardingTotalCount, cron, id)
                .overwrite(true).build();

        new SpringJobScheduler(new JavaSimpleJob(), registryCenter, jobConfig, jobEventConfiguration, elasticJobListener);
    }
}
